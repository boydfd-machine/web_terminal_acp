...
from app.contexts.activity.infrastructure.ai_sessions_repository import get_or_create_ai_session
from app.contexts.activity.infrastructure.events_repository import insert_normalized_event
from app.contexts.workspace.application.summary_scheduler import schedule_summary_after_agent_activity
from app.platform.ingest.normalizers import normalize_codex_trace
from app.platform.search_index import index_ai_event
...
async def receive_managed_codex_trace(
    ...
    *,
    ...
    from app.contexts.activity.application.agent_event_ingest import persist_managed_agent_event
...
async def receive_codex_trace(
    ...
    *,
    ...
    normalized = normalize_codex_trace(payload, source_path=source_path)
