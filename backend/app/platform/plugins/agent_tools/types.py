...
class AgentSubagentState:
    is_sidechain: bool = False
    is_call: bool = False
    is_result: bool = False
    is_async_launch: bool = False
    is_finished_notification: bool = False
    ...
    def has_state_event(self) -> bool:
        return (
            self.is_call
            or self.is_result
            or self.is_async_launch
            or self.is_finished_notification
            or self.pending_background_agent_count is not None
        )
