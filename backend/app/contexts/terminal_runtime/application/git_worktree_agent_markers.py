...
from app.contexts.terminal_runtime.infrastructure.git_worktree_repository import list_window_git_bindings
from app.contexts.terminal_runtime.application.git_worktree_coordinator import process_worktree_registration
from app.contexts.terminal_runtime.application.client_connections import ClientConnectionRegistry
from app.contexts.terminal_runtime.application.worktree_marker import (
