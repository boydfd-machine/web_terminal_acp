...
from app.platform.search_index import index_terminal_chunk_without_event
from app.contexts.workspace.application.summary_scheduler import schedule_summary_after_terminal_input
from app.contexts.terminal_runtime.application.command_marker import ParsedCommandMarker, extract_command_markers
