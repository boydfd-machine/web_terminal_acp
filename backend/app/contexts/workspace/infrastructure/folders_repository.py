...
from app.contexts.workspace.domain.folders import canonicalize_folder_path, split_folder_path
...
def window_visible_at_expression():
    candidates = [
        ...
        func.coalesce(VirtualWindow.agent_presence_latest_at, VirtualWindow.created_at),
...
def _non_ephemeral_window_filter():
    return or_(VirtualWindow.derived_mode.is_(None), VirtualWindow.derived_mode != "ephemeral")
