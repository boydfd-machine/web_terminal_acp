...
from app.contexts.workspace.application.folder_splitter import (
    FolderSplitResult,
...
from app.contexts.workspace.infrastructure.folder_split_jobs_repository import (
...
from app.contexts.workspace.infrastructure.summary_jobs_repository import collect_window_activity_context
from app.platform.search_index import get_es_client, index_summary
